...
create       trigger [dbo].[listvrstplac_utrigg] on [dbo].[listvrstplac] 
for update
as
...
begin
	...
	where checksum(inserted.skupdogadjaj,inserted.sifra, inserted.analitzat, inserted.koristi)
		<> checksum(deleted.skupdogadjaj,deleted.sifra, deleted.analitzat, deleted.koristi)
