...
begin
	...
	begin
		...
		begin
			...
			if exists (select * from inserted
					...
					inner join dbo.osvrsta with(nolock) on dbo.os.osvrstaid = dbo.osvrsta.idwhere  dbo.analitika.analitikavrsta = 6 and inserted.ks = 1
	...
	begin
		...
		where inserted.iznos <> 0 and tbsaldodok.saldo <> 0
			and pdst.plac = 1
			and dokvrsta.mp = 1
