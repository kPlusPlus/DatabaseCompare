...
if exists (select * from deleted where sifra = 100 )
begin
        	raiserror ( '
the record can''t be updated or deleted!
current account plan is reserved and
uses for international reporting.
