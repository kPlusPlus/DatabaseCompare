...
BEGIN
  ...
  DECLARE @inNoEmployees int
	...
	FROM dbo.TVSAction
	WHERE (ode)
	PRINT 'izdvojen ID za pripremu podataka za obraŔun'
  ...
  IitError
	...
	SELECT @nvTekst = 'izdvojeni podaci o tra×enoj isplati'
  ...
  IitError
	...
	SELECT @nvTekst = 'izdvojeni podaci o VKu obraŔuna plaŠe'
  INSERT INTO dbo.ObradaLog (ObradaID, Tekst) VALUES (@inObradaID, @nvTekst)
	PRINT @nvTekst
  ...
  IitError
	...
	SELECT @nvTekst = 'izdvojeni podaci mjesta troÜka'
  INSERT INTO dbo.ObradaLog (ObradaID, Tekst) VALUES (@inObradaID, @nvTekst)
  ...
  IitError
	...
	BEGIN
	  ...
	  IitError
		...
		SELECT @nvTekst = 'formirana tabela za izraŔun bruto plaŠe'
	  INSERT INTO dbo.ObradaLog (ObradaID, Tekst) VALUES (@inObradaID, @nvTekst)
		PRINT @nvTekst
	END
  ...
  IitError
	...
	SELECT @nvTekst = 'utvr­eni neprekinuti periodi prema osnovicama obraŔuna'
  INSERT INTO dbo.ObradaLog (ObradaID, Tekst) VALUES (@inObradaID, @nvTekst)
	PRINT @nvTekst
  ...
  INSERT INTO dbo.ObradaLog (ObradaID, Tekst) VALUES (@inObradaID, @nvTekst)
	...
	SELECT @nvTekst = '	a×urirani slogovi u tabeli RadniList'
  INSERT INTO dbo.ObradaLog (ObradaID, Tekst) VALUES (@inObradaID, @nvTekst)
  ...
  TION
	...
	SELECT @nvTekst = '	zavrÜno a×uriranje u tabeli DokStart'
  INSERT INTO dbo.ObradaLog (ObradaID, Tekst) VALUES (@inObradaID, @nvTekst)
...
ExitError:
	...
	SELECT 	@nvTekst = 'ZAVRŐETAK S GREŐKOM', @inReturnStatus = -1
  INSERT INTO dbo.ObradaLog (ObradaID, Tekst) VALUES (@inObradaID, @nvTekst)
	PRINT @nvTekst
...
ExitSucces:
	...
	SELECT 	@nvTekst = 'ZAVRŐETAK BEZ GREŐKE', @inReturnStatus = 0
